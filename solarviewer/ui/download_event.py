...
class Ui_DownloadEvent(object):
    def setupUi(self, DownloadEvent):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.from_date.sizePolicy().hasHeightForWidth())
        self.from_date.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.to_date.sizePolicy().hasHeightForWidth())
        self.to_date.setSizePolicy(sizePolicy)
    ...
    def retranslateUi(self, DownloadEvent):
        ...
        self.from_date.setDisplayFormat(_translate("DownloadEvent", "yyyy-MM-ddThh:mm"))
        self.label_2.setText(_translate("DownloadEvent", "-"))
        self.to_date.setDisplayFormat(_translate("DownloadEvent", "yyyy-MM-ddThh:mm"))
